...
/* harmony default export */ var Linkvue_type_script_lang_js_ = ({
  computed: {
    ...
    href: function href() {
      ...
      var route = this.getRouteForLocale();
      return route.href;
    },
    pwa: function pwa() {
  ...
  methods: {
    getCurrentRoute: function getCurrentRoute() {
      ...
      return this.$router.options.routes.find(function (route) {
        return _this.$route.path === route.path;
      });
    },
    getRouteForLocale: function getRouteForLocale() {
      var name = this.getCurrentRoute().name;
      var i = name.lastIndexOf('_');
      var route = name.slice(0, i) + '_' + this.locale;
...
// EXTERNAL MODULE: ./src/assets/scss/locale-switcher.scss
var locale_switcher = __webpack_require__("bae2");
...
/* harmony default export */ var Indexvue_type_script_lang_js_ = ({
  ...
  computed: {
    currentLocaleClass: function currentLocaleClass() {
      var cls = '';
  ...
  methods: {
    onLocaleChanged: function onLocaleChanged(locale) {
...
/******/ })["default"];
//# sourceMappingURL=localeSwitcher.common.js.map